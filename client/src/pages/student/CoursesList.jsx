...
const CoursesList = () => {
  ...
  return (
    <>
      ...
      { input && <div className='inline-flex items-center gap-4 px-4 py-2 mt-8 mb-8 text-gray-600 border'>
        <p>{input}</p>
        ...
        <div className='grid grid-cols-1 gap-3 px-2 my-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 md:p-0'>
